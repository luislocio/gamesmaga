...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  <div class="container">
    <a class="navbar-brand font-weight-bold" href="index.php"><img src="./img/icone.png" width="40" class="d-inline-block mr-2 img-thumbnail" style="background-color:#9CB66E" alt="GamEsmaga">GamEsmaga</a>
