  ...
  <main role="main" class="container">
    ...
    <form action="cadastro-distribuidora.php" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="distribuidora" id="distribuidora" placeholder="Distribuidora de jogos" value="<?php echo $distribuidora?>" required>
      </div>
    ...
    <table class="table mt-3 table-sm table-bordered table-hover">
      <tr>
        ...
        <tr>
          ...
          <td class="text-center"><a class="btn btn-primary" href="cadastro-distribuidora.php?acao=editar&id=<?php echo $distribuidora['id']?>">Editar</a></td>
            <?php if ($_SESSION['login']['acesso'] != "logistica") { ?>
            <td class="text-center"><a class="btn btn-danger" href="cadastro-distribuidora.php?acao=excluir&id=<?php echo $distribuidora['id']?>">Excluir</a></td>
            <?php } ?>
        </tr>
        <?php } ?>
    </table>
